(() => {
    ...
    function initSliders() {
        if (document.querySelector(".hero__slider")) {
            const mainSlider = new swiper_core_Swiper(".hero__slider", {
                ...
                pagination: {
                    ...
                    renderBullet: function(index, className) {
                        return `<div data-slide="${index}" class="${className}">${index < 10 ? "0" + (index + 1) : index + 1}</div>`;
                    }
                },
                on: {}
            });
            document.addEventListener("click", (function(e) {
                ...
                if (targetElement.classList.contains("swiper-pagination-bullet") && targetElement.closest(".control-main")) {
        ...
        if (document.querySelector(".quote__slider")) {
            const mainSlider = new swiper_core_Swiper(".quote__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
